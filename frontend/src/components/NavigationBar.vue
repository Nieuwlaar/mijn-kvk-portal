  ...
  <div class="flex items-center gap-x-6 bg-gray-200 px-6 sm:px-3.5 sm:before:flex-1">
    <p class="text-sm leading-6 text-white">
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end items-center">
        ...
        <a href="#" class="text-xs font-semibold leading-6 text-gray-900">Nederlands</a>
        <UserIcon class="ml-3 h-3 w-4 mr-4 flex-none text-gray-900" aria-hidden="true" />
        <a href="#" class="text-xs mr-4 font-semibold leading-6 text-gray-900">Inloggen</a>
      </div>
    </p>
  </div>
  ...
  <header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-start p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:flex-1 lg:justify-end items-center">
        ...
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Zoeken</a>
      </div>
...
import { UserIcon, GlobeAltIcon } from '@heroicons/vue/24/outline'
